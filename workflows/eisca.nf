...
workflow EISCA {
    ...
    if (params.run_analyses.any{ it in ['secondary', 'cellbender', 'qccellfilter', 'clustering'] }){
        ...
        if(params.run_analyses.contains('primary')){
            ...
            def path1 = [
                'kallisto': "${params.outdir}/kallisto/mtx_conversions/combined_raw_matrix.h5ad",
                'alevin': "${params.outdir}/alevin/mtx_conversions/combined_raw_matrix.h5ad",
                'star': "${params.outdir}/star/mtx_conversions/combined_raw_matrix.h5ad"
            ].get(params.aligner)
            def path2 = "${params.outdir}/cellbender/mtx_conversions/combined_raw_matrix_cellbender_filter.h5ad"
        ...
        ch_h5ad.ifEmpty {
            ...
            for the h5ad file generated by the aligner or by setting --h5ad for an existing h5ad file.""")
            return
        }
